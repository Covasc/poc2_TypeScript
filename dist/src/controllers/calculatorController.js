...
export function addNewSchedule(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var schedule, error, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    schedule = req.body;
                    error = ScheduleSchema.validate(schedule).error;
                    if (error) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, scheduleById(schedule)];
                case 2:
                    _a.sent();
                    res.sendStatus(200);
                    return [3 /*break*/, 4];
...
export function deleteSchedule(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, error, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.body;
                    error = DeleteSchema.validate(id).error;
                    if (error) {
                        return [2 /*return*/, res.status(400).send({
                                message: error.message
                            })];
